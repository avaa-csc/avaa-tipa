...
public final class TupaConst {
	...
	public static final String BASE_LEGACY_URN = "urn:nbn:fi:csc-infras-";
	public static final String BASE_URN = "urn:nbn:fi:research-infras-";
	public static final String SCHEMA_LOCATION = "urn:nbn:se:uu:ub:epc-schema:rs-location-mapping http://urn.kb.se/resolve?urn=urn:nbn:se:uu:ub:epc-schema:rs-location-mapping&godirectly";
	...
	public static final String AVAINSANA = "avainsana";
	public static final String KEYWORD = "keyword";
	public static final String AVAINSANA_ID = "avainsana_id";
	public static final String PRIMARY_KEY_INFRA_ID = "primaryKey.infra_id";
	public static final String PRIMARY_KEY_AVAINSANA_ID = "primaryKey.avainsana_id";
	public static final String PRIMARY_KEY_PALVELU_ID = "primaryKey.palvelu_id";
	public static final String PRIMARY_KEY_ORGANISAATIO_ID = "primaryKey.organisaatio_id";
	public static final String PRIMARY_KEY_YHTEYSTIETO_ID = "primaryKey.yhteystieto_id";
	public static final String PRIMARY_KEY_PALVELUTYYPPI_ID = "primaryKey.palvelutyyppi_id";
	public static final String KATUOSOITE = "katuosoite";
	public static final String ANYSYMBOL_SQL = "%";

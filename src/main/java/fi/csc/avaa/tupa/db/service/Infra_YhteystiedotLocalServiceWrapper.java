...
public class Infra_YhteystiedotLocalServiceWrapper
    ...
    */
    ...
    public int[] getContactsIdsByInfrastructureId(int infrastructureId) {
        return _infra_YhteystiedotLocalService.getContactsIdsByInfrastructureId(infrastructureId);
    }

    @Override
    public int[] getContactsIdsByInfrastructuresIds(int[] infrastructuresIds) {
        return _infra_YhteystiedotLocalService.getContactsIdsByInfrastructuresIds(infrastructuresIds);
    }

    @Override
    public int[] getInfrastructuresIdsByContactsIds(int[] contactsIds) {
        return _infra_YhteystiedotLocalService.getInfrastructuresIdsByContactsIds(contactsIds);
    }

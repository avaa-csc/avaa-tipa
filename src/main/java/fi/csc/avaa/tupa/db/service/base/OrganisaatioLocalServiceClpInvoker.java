...
public class OrganisaatioLocalServiceClpInvoker {
    ...
    public OrganisaatioLocalServiceClpInvoker() {
        ...
        _methodName124 = "getInfrastructuresIdsByOrganisationId";

        _methodParameterTypes124 = new String[] { "int" };

        _methodName125 = "getServicesIdsByOrganisationId";

        _methodParameterTypes125 = new String[] { "int" };

        _methodName126 = "getContactsIdsByOrganisationId";

        _methodParameterTypes126 = new String[] { "int" };

        _methodName127 = "getCountries";

        _methodParameterTypes127 = new String[] {  };

        _methodName128 = "getOrganisationsIdsByCountries";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName124.equals(name) &&
            ...
            return OrganisaatioLocalServiceUtil.getInfrastructuresIdsByOrganisationId(((Integer) arguments[0]).intValue());
        }

        if (_methodName125.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes125, parameterTypes)) {
            return OrganisaatioLocalServiceUtil.getServicesIdsByOrganisationId(((Integer) arguments[0]).intValue());
        }

        if (_methodName126.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes126, parameterTypes)) {
            return OrganisaatioLocalServiceUtil.getContactsIdsByOrganisationId(((Integer) arguments[0]).intValue());
        }
        ...
        if (_methodName128.equals(name) &&
            ...
            return OrganisaatioLocalServiceUtil.getOrganisationsIdsByCountries((java.lang.String[]) arguments[0]);
        }

...
public class PalveluModelImpl extends BaseModelImpl<Palvelu>
    ...
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.fi.csc.avaa.tupa.db.model.Palvelu"),
            true);
    public static long LAT_COLUMN_BITMASK = 1L;
    public static long LON_COLUMN_BITMASK = 2L;
    public static long PAIKKATYYPPI_COLUMN_BITMASK = 4L;
    public static long PALVELU_ID_COLUMN_BITMASK = 8L;
    ...
    private int _originalPaikkatyyppi;
    private boolean _setOriginalPaikkatyyppi;
    private String _katuosoite;
    private String _kaupunki;
    private double _lat;
    private double _originalLat;
    private boolean _setOriginalLat;
    private double _lon;
    private double _originalLon;
    private boolean _setOriginalLon;
    ...
    public void setPaikkatyyppi(int paikkatyyppi) {
        _columnBitmask |= PAIKKATYYPPI_COLUMN_BITMASK;

        if (!_setOriginalPaikkatyyppi) {
            _setOriginalPaikkatyyppi = true;

            _originalPaikkatyyppi = _paikkatyyppi;
        }

        _paikkatyyppi = paikkatyyppi;
    }

    public int getOriginalPaikkatyyppi() {
        return _originalPaikkatyyppi;
    }
    ...
    public void setLat(double lat) {
        _columnBitmask |= LAT_COLUMN_BITMASK;

        if (!_setOriginalLat) {
            _setOriginalLat = true;
    ...
    public void setLon(double lon) {
        _columnBitmask |= LON_COLUMN_BITMASK;

        if (!_setOriginalLon) {
            _setOriginalLon = true;
    ...
    public void resetOriginalValues() {
        PalveluModelImpl palveluModelImpl = this;

        palveluModelImpl._originalPaikkatyyppi = palveluModelImpl._paikkatyyppi;

        palveluModelImpl._setOriginalPaikkatyyppi = false;

        palveluModelImpl._originalLat = palveluModelImpl._lat;

        palveluModelImpl._setOriginalLat = false;

        palveluModelImpl._originalLon = palveluModelImpl._lon;

        palveluModelImpl._setOriginalLon = false;

        palveluModelImpl._columnBitmask = 0;
    }

...
public class SeliteLocalServiceWrapper implements SeliteLocalService,
    ...
    */
    ...
    public int[] getDefinitionsIdsByServiceTypes(
        ...
        return _seliteLocalService.getDefinitionsIdsByServiceTypes(serviceTypes);
    }

    @Override
    public int[] getLocationTypesIdsByLocationTypes(
        java.lang.String[] locationTypes) {
        return _seliteLocalService.getLocationTypesIdsByLocationTypes(locationTypes);
    }

    @Override
    public java.lang.String[][] getLocationTypesByClassificator() {
        return _seliteLocalService.getLocationTypesByClassificator();
    }

    @Override
    public java.lang.String[][] getServiceTypesByClassificator() {
        return _seliteLocalService.getServiceTypesByClassificator();
    }

    @Override
    public java.lang.String[] getTypesByDefinitionsIds(int[] definitionsIds) {
        return _seliteLocalService.getTypesByDefinitionsIds(definitionsIds);
    }

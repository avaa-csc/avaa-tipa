...
public class InfraCacheModel implements CacheModel<Infra>, Externalizable {
    ...
    public Infra toEntityModel() {
        ...
        if (api_date == Long.MIN_VALUE) {
            infraImpl.setApi_date(null);
        } else {
            infraImpl.setApi_date(new Date(api_date));
        }
    ...
    public void writeExternal(ObjectOutput objectOutput)
        ...
        objectOutput.writeLong(api_date);
    }
}

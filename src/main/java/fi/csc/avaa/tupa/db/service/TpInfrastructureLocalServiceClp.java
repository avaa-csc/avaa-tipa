 ...
 * @generated
 */
public class TpInfrastructureLocalServiceClp
    ...
    public TpInfrastructureLocalServiceClp(
        ...
        _methodName19 = "getAllInfrastructures";

        _methodParameterTypes19 = new String[] {  };

        _methodName20 = "getInfrastructuresByInfrastructuresIds";

        _methodParameterTypes20 = new String[] { "int[][]" };

        _methodName21 = "getInfrastructuresByUrns";

        _methodParameterTypes21 = new String[] { "java.lang.String[][]" };

        _methodName22 = "getInfrastructuresByOrganisationIds";

        _methodParameterTypes22 = new String[] { "int[][]" };

        _methodName23 = "getInfrastructuresByServiceIds";

        _methodParameterTypes23 = new String[] { "int[][]" };

        _methodName24 = "getInfrastructuresByContactIds";

        _methodParameterTypes24 = new String[] { "int[][]" };

        _methodName25 = "getInfrastructuresByKeywords";

        _methodParameterTypes25 = new String[] { "java.lang.String[][]" };

        _methodName26 = "getInfrastructuresByServiceTypes";

        _methodParameterTypes26 = new String[] { "java.lang.String[][]" };

        _methodName27 = "getInfrastructuresByLocationTypes";

        _methodParameterTypes27 = new String[] { "java.lang.String[][]" };

        _methodName28 = "getInfrastructuresByPostalCodes";

        _methodParameterTypes28 = new String[] { "int[][]" };

        _methodName29 = "getInfrastructuresByLocation";

        _methodParameterTypes29 = new String[] { "double", "double" };

        _methodName30 = "getInfrastructuresByCountries";

        _methodParameterTypes30 = new String[] { "java.lang.String[][]" };

        _methodName31 = "getInfrastructuresByPreviousIds";

        _methodParameterTypes31 = new String[] { "int[][]" };

        _methodName32 = "getKeywords";

        _methodParameterTypes32 = new String[] {  };

        _methodName33 = "getPids";

        _methodParameterTypes33 = new String[] {  };

        _methodName34 = "getInfrastructuresByPids";

        _methodParameterTypes34 = new String[] { "java.lang.String[][]" };

        _methodName35 = "getInfrastructuresByPreviousUrns";

        _methodParameterTypes35 = new String[] { "java.lang.String[][]" };

        _methodName36 = "getInfrastructuresIdsByUrns";

        _methodParameterTypes36 = new String[] { "java.lang.String[][]" };

        _methodName37 = "getPidsJson";
    ...
    public fi.csc.avaa.tupa.db.model.TpInfrastructure addTpInfrastructure(
        ...
        return (fi.csc.avaa.tupa.db.model.TpInfrastructure) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.avaa.tupa.db.model.TpInfrastructure> getInfrastructuresByUrns(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName21,
                    ...
                    new Object[] { ClpSerializer.translateInput(urns) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.liferay.portal.kernel.json.JSONObject getPidsJson(int infraId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName37,
                    _methodParameterTypes37, new Object[] { infraId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);

 ...
 * @generated
 */
public class Infra_PalvelutLocalServiceClp implements Infra_PalvelutLocalService {
    ...
    public Infra_PalvelutLocalServiceClp(
        ...
        _methodName19 = "getServicesIdsByInfrastructureId";

        _methodParameterTypes19 = new String[] { "int" };

        _methodName20 = "getServicesIdsByInfrastructuresIds";

        _methodParameterTypes20 = new String[] { "int[][]" };

        _methodName21 = "getInfrastructuresIdsByServicesIds";
    ...
    public fi.csc.avaa.tupa.db.model.Infra_Palvelut addInfra_Palvelut(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(infra_Palvelut) });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.tupa.db.model.Infra_Palvelut) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.avaa.tupa.db.model.Infra_Palvelut> getInfra_Palveluts(
        ...
        return (java.util.List<fi.csc.avaa.tupa.db.model.Infra_Palvelut>) ClpSerializer.translateOutput(returnObj);
    }

 ...
 * @generated
 */
public class Infra_AvainsanatLocalServiceClp
    ...
    public Infra_AvainsanatLocalServiceClp(
        ...
        _methodName19 = "getKeywordsIdsByInfrastructureId";

        _methodParameterTypes19 = new String[] { "int" };

        _methodName20 = "getKeywordsIdsByInfrastructuresIds";

        _methodParameterTypes20 = new String[] { "int[][]" };

        _methodName21 = "getInfrastructuresIdsByKeywordsIds";
    ...
    public fi.csc.avaa.tupa.db.model.Infra_Avainsanat addInfra_Avainsanat(
        ...
        return (fi.csc.avaa.tupa.db.model.Infra_Avainsanat) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.tupa.db.model.Infra_Avainsanat createInfra_Avainsanat(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(infra_AvainsanatPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.avaa.tupa.db.model.Infra_Avainsanat> getInfra_Avainsanats(
        ...
        return (java.util.List<fi.csc.avaa.tupa.db.model.Infra_Avainsanat>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public int[] getInfrastructuresIdsByKeywordsIds(int[] keywordsIds) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName21,
                    ...
                    new Object[] { ClpSerializer.translateInput(keywordsIds) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);

 ...
 * @generated
 */
public class InfraLocalServiceClp implements InfraLocalService {
    ...
    public InfraLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public fi.csc.avaa.tupa.db.model.Infra addInfra(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(infra) });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.tupa.db.model.Infra) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.tupa.db.model.Infra createInfra(int infra_id) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { infra_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.tupa.db.model.Infra deleteInfra(int infra_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { infra_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.tupa.db.model.Infra fetchInfra(int infra_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { infra_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.tupa.db.model.Infra getInfra(int infra_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { infra_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.avaa.tupa.db.model.Infra> getInfras(
        ...
        return (java.util.List<fi.csc.avaa.tupa.db.model.Infra>) ClpSerializer.translateOutput(returnObj);
    }

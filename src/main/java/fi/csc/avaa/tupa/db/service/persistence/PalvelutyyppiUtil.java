...
public class PalvelutyyppiUtil {
    ...
    */
    public static java.util.List<fi.csc.avaa.tupa.db.model.Palvelutyyppi> findBydefinitionId(
        int tyyppi) throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().findBydefinitionId(tyyppi);
    }
    ...
    */
    public static java.util.List<fi.csc.avaa.tupa.db.model.Palvelutyyppi> findBydefinitionId(
        ...
        return getPersistence().findBydefinitionId(tyyppi, start, end);
    }
    ...
    */
    public static java.util.List<fi.csc.avaa.tupa.db.model.Palvelutyyppi> findBydefinitionId(
        ...
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
                   .findBydefinitionId(tyyppi, start, end, orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.avaa.tupa.db.model.Palvelutyyppi findBydefinitionId_First(
        int tyyppi,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.avaa.tupa.db.NoSuchPalvelutyyppiException {
        return getPersistence()
                   .findBydefinitionId_First(tyyppi, orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.avaa.tupa.db.model.Palvelutyyppi fetchBydefinitionId_First(
        int tyyppi,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
                   .fetchBydefinitionId_First(tyyppi, orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.avaa.tupa.db.model.Palvelutyyppi findBydefinitionId_Last(
        int tyyppi,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.avaa.tupa.db.NoSuchPalvelutyyppiException {
        return getPersistence()
                   .findBydefinitionId_Last(tyyppi, orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.avaa.tupa.db.model.Palvelutyyppi fetchBydefinitionId_Last(
        int tyyppi,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence()
                   .fetchBydefinitionId_Last(tyyppi, orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.avaa.tupa.db.model.Palvelutyyppi[] findBydefinitionId_PrevAndNext(
        int palvelutyyppi_id, int tyyppi,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.avaa.tupa.db.NoSuchPalvelutyyppiException {
        return getPersistence()
                   .findBydefinitionId_PrevAndNext(palvelutyyppi_id, tyyppi,
            orderByComparator);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static void removeBydefinitionId(int tyyppi)
        throws com.liferay.portal.kernel.exception.SystemException {
        getPersistence().removeBydefinitionId(tyyppi);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int countBydefinitionId(int tyyppi)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().countBydefinitionId(tyyppi);
    }

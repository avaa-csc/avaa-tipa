 ...
 * @generated
 */
public class TpContactLocalServiceClp implements TpContactLocalService {
    ...
    public TpContactLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "getAllContacts";

        _methodParameterTypes19 = new String[] {  };

        _methodName20 = "getContactsByContactsIds";

        _methodParameterTypes20 = new String[] { "int[][]" };

        _methodName21 = "getContactsByInfrastructuresIds";

        _methodParameterTypes21 = new String[] { "int[][]" };

        _methodName22 = "getContactsByInfrastructuresUrns";

        _methodParameterTypes22 = new String[] { "java.lang.String[][]" };

        _methodName23 = "getContactsByOrganisationsIds";

        _methodParameterTypes23 = new String[] { "int[][]" };

        _methodName24 = "getContactsByServicesIds";

        _methodParameterTypes24 = new String[] { "int[][]" };

        _methodName25 = "getTpContactFromYhteystieto";
    ...
    public fi.csc.avaa.tupa.db.model.TpContact addTpContact(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(tpContact) });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.tupa.db.model.TpContact) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.tupa.db.model.TpContact getTpContactFromYhteystieto(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName25,
                    ...
                    new Object[] { ClpSerializer.translateInput(yhteystieto) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);

...
/**
 * Provides the remote service interface for TpContact. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author CSC
 * @see TpContactServiceUtil
...
public interface TpContactService extends BaseService, InvokableService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link TpContactServiceUtil} to access the tp contact remote service. Add custom service methods to {@link fi.csc.avaa.tupa.db.service.impl.TpContactServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */

 ...
 * @generated
 */
public class Infra_YhteystiedotLocalServiceClp
    ...
    public Infra_YhteystiedotLocalServiceClp(
        ...
        _methodName19 = "getContactsIdsByInfrastructureId";

        _methodParameterTypes19 = new String[] { "int" };

        _methodName20 = "getContactsIdsByInfrastructuresIds";

        _methodParameterTypes20 = new String[] { "int[][]" };

        _methodName21 = "getInfrastructuresIdsByContactsIds";
    ...
    public fi.csc.avaa.tupa.db.model.Infra_Yhteystiedot addInfra_Yhteystiedot(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(infra_Yhteystiedot)
                    });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.tupa.db.model.Infra_Yhteystiedot) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.tupa.db.model.Infra_Yhteystiedot createInfra_Yhteystiedot(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(infra_YhteystiedotPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.avaa.tupa.db.model.Infra_Yhteystiedot> getInfra_Yhteystiedots(
        ...
        return (java.util.List<fi.csc.avaa.tupa.db.model.Infra_Yhteystiedot>) ClpSerializer.translateOutput(returnObj);
    }

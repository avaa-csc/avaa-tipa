...
import fi.csc.avaa.tupa.db.model.IdentifierClp;
import fi.csc.avaa.tupa.db.model.InfraClp;
import fi.csc.avaa.tupa.db.model.Infra_AvainsanatClp;
import fi.csc.avaa.tupa.db.model.Infra_IdentifierClp;
...
import fi.csc.avaa.tupa.db.model.TpAPIClp;
import fi.csc.avaa.tupa.db.model.TpContactClp;
import fi.csc.avaa.tupa.db.model.TpInfrastructureClp;
import fi.csc.avaa.tupa.db.model.TpOrganisationClp;
import fi.csc.avaa.tupa.db.model.TpServizeClp;
...
public class ClpSerializer {
    ...
    public static Object translateInput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(IdentifierClp.class.getName())) {
            return translateInputIdentifier(oldModel);
        }
        ...
        if (oldModelClassName.equals(Infra_IdentifierClp.class.getName())) {
            return translateInputInfra_Identifier(oldModel);
        }
        ...
        if (oldModelClassName.equals(TpAPIClp.class.getName())) {
            return translateInputTpAPI(oldModel);
        }

        if (oldModelClassName.equals(TpContactClp.class.getName())) {
            return translateInputTpContact(oldModel);
        }

        if (oldModelClassName.equals(TpInfrastructureClp.class.getName())) {
            return translateInputTpInfrastructure(oldModel);
        }

        if (oldModelClassName.equals(TpOrganisationClp.class.getName())) {
            return translateInputTpOrganisation(oldModel);
        }

        if (oldModelClassName.equals(TpServizeClp.class.getName())) {
            return translateInputTpServize(oldModel);
        }
    ...
    public static Object translateInputIdentifier(BaseModel<?> oldModel) {
        IdentifierClp oldClpModel = (IdentifierClp) oldModel;

        BaseModel<?> newModel = oldClpModel.getIdentifierRemoteModel();
    ...
    public static Object translateInputInfra_Identifier(BaseModel<?> oldModel) {
        Infra_IdentifierClp oldClpModel = (Infra_IdentifierClp) oldModel;

        BaseModel<?> newModel = oldClpModel.getInfra_IdentifierRemoteModel();
    ...
    public static Object translateInputTpAPI(BaseModel<?> oldModel) {
        TpAPIClp oldClpModel = (TpAPIClp) oldModel;

        BaseModel<?> newModel = oldClpModel.getTpAPIRemoteModel();
    ...
    public static Object translateInputTpContact(BaseModel<?> oldModel) {
        TpContactClp oldClpModel = (TpContactClp) oldModel;

        BaseModel<?> newModel = oldClpModel.getTpContactRemoteModel();
    ...
    public static Object translateInputTpInfrastructure(BaseModel<?> oldModel) {
        TpInfrastructureClp oldClpModel = (TpInfrastructureClp) oldModel;

        BaseModel<?> newModel = oldClpModel.getTpInfrastructureRemoteModel();
    ...
    public static Object translateInputTpOrganisation(BaseModel<?> oldModel) {
        TpOrganisationClp oldClpModel = (TpOrganisationClp) oldModel;

        BaseModel<?> newModel = oldClpModel.getTpOrganisationRemoteModel();
    ...
    public static Object translateInputTpServize(BaseModel<?> oldModel) {
        TpServizeClp oldClpModel = (TpServizeClp) oldModel;

        BaseModel<?> newModel = oldClpModel.getTpServizeRemoteModel();
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "fi.csc.avaa.tupa.db.model.impl.IdentifierImpl")) {
            return translateOutputIdentifier(oldModel);
        } else if (oldModelClassName.endsWith("Clp")) {
            try {
                ClassLoader classLoader = ClpSerializer.class.getClassLoader();
        ...
        if (oldModelClassName.equals(
                    "fi.csc.avaa.tupa.db.model.impl.Infra_IdentifierImpl")) {
            return translateOutputInfra_Identifier(oldModel);
        } else if (oldModelClassName.endsWith("Clp")) {
            try {
                ClassLoader classLoader = ClpSerializer.class.getClassLoader();
        ...
        if (oldModelClassName.equals("fi.csc.avaa.tupa.db.model.impl.TpAPIImpl")) {
            return translateOutputTpAPI(oldModel);
        } else if (oldModelClassName.endsWith("Clp")) {
            try {
                ClassLoader classLoader = ClpSerializer.class.getClassLoader();
        ...
        if (oldModelClassName.equals(
                    "fi.csc.avaa.tupa.db.model.impl.TpContactImpl")) {
            return translateOutputTpContact(oldModel);
        } else if (oldModelClassName.endsWith("Clp")) {
            try {
                ClassLoader classLoader = ClpSerializer.class.getClassLoader();
        ...
        if (oldModelClassName.equals(
                    "fi.csc.avaa.tupa.db.model.impl.TpInfrastructureImpl")) {
            return translateOutputTpInfrastructure(oldModel);
        } else if (oldModelClassName.endsWith("Clp")) {
            try {
                ClassLoader classLoader = ClpSerializer.class.getClassLoader();
        ...
        if (oldModelClassName.equals(
                    "fi.csc.avaa.tupa.db.model.impl.TpOrganisationImpl")) {
            return translateOutputTpOrganisation(oldModel);
        } else if (oldModelClassName.endsWith("Clp")) {
            try {
                ClassLoader classLoader = ClpSerializer.class.getClassLoader();
        ...
        if (oldModelClassName.equals(
                    "fi.csc.avaa.tupa.db.model.impl.TpServizeImpl")) {
            return translateOutputTpServize(oldModel);
        } else if (oldModelClassName.endsWith("Clp")) {
            try {
                ClassLoader classLoader = ClpSerializer.class.getClassLoader();
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("fi.csc.avaa.tupa.db.NoSuchIdentifierException")) {
            return new fi.csc.avaa.tupa.db.NoSuchIdentifierException();
        }
        ...
        if (className.equals(
            ...
            return new fi.csc.avaa.tupa.db.NoSuchInfra_IdentifierException();
        }
        ...
        if (className.equals("fi.csc.avaa.tupa.db.NoSuchTpAPIException")) {
            return new fi.csc.avaa.tupa.db.NoSuchTpAPIException();
        }

        if (className.equals("fi.csc.avaa.tupa.db.NoSuchTpContactException")) {
            return new fi.csc.avaa.tupa.db.NoSuchTpContactException();
        }

        if (className.equals(
                    "fi.csc.avaa.tupa.db.NoSuchTpInfrastructureException")) {
            return new fi.csc.avaa.tupa.db.NoSuchTpInfrastructureException();
        }

        if (className.equals(
                    "fi.csc.avaa.tupa.db.NoSuchTpOrganisationException")) {
            return new fi.csc.avaa.tupa.db.NoSuchTpOrganisationException();
        }

        if (className.equals("fi.csc.avaa.tupa.db.NoSuchTpServizeException")) {
            return new fi.csc.avaa.tupa.db.NoSuchTpServizeException();
        }
    ...
    public static Object translateOutputIdentifier(BaseModel<?> oldModel) {
        IdentifierClp newModel = new IdentifierClp();

        newModel.setModelAttributes(oldModel.getModelAttributes());

        newModel.setIdentifierRemoteModel(oldModel);
    ...
    public static Object translateOutputInfra_Identifier(BaseModel<?> oldModel) {
        Infra_IdentifierClp newModel = new Infra_IdentifierClp();

        newModel.setModelAttributes(oldModel.getModelAttributes());

        newModel.setInfra_IdentifierRemoteModel(oldModel);
    ...
    public static Object translateOutputTpAPI(BaseModel<?> oldModel) {
        TpAPIClp newModel = new TpAPIClp();

        newModel.setModelAttributes(oldModel.getModelAttributes());

        newModel.setTpAPIRemoteModel(oldModel);

        return newModel;
    }

    public static Object translateOutputTpContact(BaseModel<?> oldModel) {
        TpContactClp newModel = new TpContactClp();

        newModel.setModelAttributes(oldModel.getModelAttributes());

        newModel.setTpContactRemoteModel(oldModel);

        return newModel;
    }

    public static Object translateOutputTpInfrastructure(BaseModel<?> oldModel) {
        TpInfrastructureClp newModel = new TpInfrastructureClp();

        newModel.setModelAttributes(oldModel.getModelAttributes());

        newModel.setTpInfrastructureRemoteModel(oldModel);

        return newModel;
    }

    public static Object translateOutputTpOrganisation(BaseModel<?> oldModel) {
        TpOrganisationClp newModel = new TpOrganisationClp();

        newModel.setModelAttributes(oldModel.getModelAttributes());

        newModel.setTpOrganisationRemoteModel(oldModel);

        return newModel;
    }

    public static Object translateOutputTpServize(BaseModel<?> oldModel) {
        TpServizeClp newModel = new TpServizeClp();

        newModel.setModelAttributes(oldModel.getModelAttributes());

        newModel.setTpServizeRemoteModel(oldModel);

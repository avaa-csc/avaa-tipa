 ...
 * @generated
 */
public class PalveluLocalServiceClp implements PalveluLocalService {
    ...
    public PalveluLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "getInfrastructuresIdsByServiceId";

        _methodParameterTypes19 = new String[] { "int" };

        _methodName20 = "getOrganisationsIdsByServiceId";

        _methodParameterTypes20 = new String[] { "int" };

        _methodName21 = "getContactsIdsByServiceId";

        _methodParameterTypes21 = new String[] { "int" };

        _methodName22 = "getLocationTypesByServiceId";

        _methodParameterTypes22 = new String[] { "int" };

        _methodName23 = "getServiceTypesByServiceId";

        _methodParameterTypes23 = new String[] { "int" };

        _methodName24 = "getServicesIdsByPostalCodes";

        _methodParameterTypes24 = new String[] { "int[][]" };

        _methodName25 = "getServicesIdsByLocation";

        _methodParameterTypes25 = new String[] { "double", "double" };

        _methodName26 = "getServiceTypesIdsByServicesIds";

        _methodParameterTypes26 = new String[] { "int[][]" };

        _methodName27 = "getServicesIdsByLocationTypesIds";

        _methodParameterTypes27 = new String[] { "int[][]" };

        _methodName28 = "getLocationTypesIdsByServicesIds";
    ...
    public fi.csc.avaa.tupa.db.model.Palvelu addPalvelu(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(palvelu) });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.tupa.db.model.Palvelu) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.tupa.db.model.Palvelu createPalvelu(int palvelu_id) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { palvelu_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.tupa.db.model.Palvelu deletePalvelu(int palvelu_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { palvelu_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.tupa.db.model.Palvelu fetchPalvelu(int palvelu_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { palvelu_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.tupa.db.model.Palvelu getPalvelu(int palvelu_id)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { palvelu_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.avaa.tupa.db.model.Palvelu> getPalvelus(
        ...
        return (java.util.List<fi.csc.avaa.tupa.db.model.Palvelu>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public int[] getOrganisationsIdsByServiceId(int serviceId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName20,
                    _methodParameterTypes20, new Object[] { serviceId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);

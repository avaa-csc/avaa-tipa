...
public class SeliteModelImpl extends BaseModelImpl<Selite>
    ...
    public static final Object[][] TABLE_COLUMNS = {
            ...
            { "classificator", Types.VARCHAR }
        };
    public static final String TABLE_SQL_CREATE = "create table selite (selite_id INTEGER not null primary key,nimi VARCHAR(75) null,name VARCHAR(75) null,kuvaus VARCHAR(75) null,description VARCHAR(75) null,classificator VARCHAR(75) null)";
    ...
    public Object clone() {
        ...
        seliteImpl.setClassificator(getClassificator());
    ...
    public CacheModel<Selite> toCacheModel() {
        ...
        seliteCacheModel.classificator = getClassificator();

        String classificator = seliteCacheModel.classificator;

        if ((classificator != null) && (classificator.length() == 0)) {
            seliteCacheModel.classificator = null;
        }

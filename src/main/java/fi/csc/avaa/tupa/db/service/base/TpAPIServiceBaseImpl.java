...
import fi.csc.avaa.tupa.db.service.TpAPIService;
...
/**
 * Provides the base implementation for the tp a p i remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link fi.csc.avaa.tupa.db.service.impl.TpAPIServiceImpl}.
 * </p>
 *
 * @author CSC
 ...
 * @generated
 */
public abstract class TpAPIServiceBaseImpl extends BaseServiceImpl
    implements TpAPIService, IdentifiableBean {
    ...
    private TpAPIServiceClpInvoker _clpInvoker = new TpAPIServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link fi.csc.avaa.tupa.db.service.TpAPIServiceUtil} to access the tp a p i remote service.
     */

 ...
 * @generated
 */
public class Infra_VastuuorganisaatiotLocalServiceClp
    ...
    public Infra_VastuuorganisaatiotLocalServiceClp(
        ...
        _methodName19 = "getOrganisationsIdsByInfrastructureId";

        _methodParameterTypes19 = new String[] { "int" };

        _methodName20 = "getOrganisationsIdsByInfrastructuresIds";

        _methodParameterTypes20 = new String[] { "int[][]" };

        _methodName21 = "getInfrastructuresIdsByOrganisationsIds";
    ...
    public fi.csc.avaa.tupa.db.model.Infra_Vastuuorganisaatiot addInfra_Vastuuorganisaatiot(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(infra_Vastuuorganisaatiot)
                    });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.tupa.db.model.Infra_Vastuuorganisaatiot) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.avaa.tupa.db.model.Infra_Vastuuorganisaatiot> getInfra_Vastuuorganisaatiots(
        ...
        return (java.util.List<fi.csc.avaa.tupa.db.model.Infra_Vastuuorganisaatiot>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public int[] getOrganisationsIdsByInfrastructureId(int infrastructureId) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { infrastructureId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);

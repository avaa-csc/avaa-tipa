...
public class YhteystietoLocalServiceClpInvoker {
    ...
    public YhteystietoLocalServiceClpInvoker() {
        ...
        _methodName124 = "getInfrastructuresIdsByContactId";

        _methodParameterTypes124 = new String[] { "int" };

        _methodName125 = "getServicesIdsByContactId";

        _methodParameterTypes125 = new String[] { "int" };

        _methodName126 = "getOrganisationsIdsByContactId";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName124.equals(name) &&
            ...
            return YhteystietoLocalServiceUtil.getInfrastructuresIdsByContactId(((Integer) arguments[0]).intValue());
        }

        if (_methodName125.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes125, parameterTypes)) {
            return YhteystietoLocalServiceUtil.getServicesIdsByContactId(((Integer) arguments[0]).intValue());
        }

        if (_methodName126.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes126, parameterTypes)) {
            return YhteystietoLocalServiceUtil.getOrganisationsIdsByContactId(((Integer) arguments[0]).intValue());
        }

...
public class SeliteClp extends BaseModelImpl<Selite> implements Selite {
    ...
    public void setClassificator(String classificator) {
        ...
        if (_seliteRemoteModel != null) {
            try {
                ...
                Method method = clazz.getMethod("setClassificator", String.class);

                method.invoke(_seliteRemoteModel, classificator);
            } catch (Exception e) {
                throw new UnsupportedOperationException(e);
            }
        }
    ...
    public Object clone() {
        ...
        clone.setClassificator(getClassificator());
    ...
    public String toString() {
        ...
        sb.append(", classificator=");
        sb.append(getClassificator());
        sb.append("}");
    ...
    public String toXmlString() {
        ...
        sb.append("]]></column-value></column>");
        sb.append(
            "<column><column-name>classificator</column-name><column-value><![CDATA[");
        sb.append(getClassificator());
        sb.append("]]></column-value></column>");

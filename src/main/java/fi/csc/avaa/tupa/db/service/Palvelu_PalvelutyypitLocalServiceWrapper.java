...
public class Palvelu_PalvelutyypitLocalServiceWrapper
    ...
    */
    ...
    public int[] getServiceTypesIdsByServiceId(int serviceId) {
        return _palvelu_PalvelutyypitLocalService.getServiceTypesIdsByServiceId(serviceId);
    }

    @Override
    public int[] getServiceTypesIdsByServicesIds(int[] servicesIds) {
        return _palvelu_PalvelutyypitLocalService.getServiceTypesIdsByServicesIds(servicesIds);
    }

    @Override
    public int[] getServicesIdsByServiceTypesIds(int[] serviceTypesIds) {
        return _palvelu_PalvelutyypitLocalService.getServicesIdsByServiceTypesIds(serviceTypesIds);
    }

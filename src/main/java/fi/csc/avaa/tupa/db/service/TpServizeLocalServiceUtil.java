...
/**
 * Provides the local service utility for TpServize. This utility wraps
 * {@link fi.csc.avaa.tupa.db.service.impl.TpServizeLocalServiceImpl} and is the
 ...
 * @generated
 */
public class TpServizeLocalServiceUtil {
    private static TpServizeLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link fi.csc.avaa.tupa.db.service.impl.TpServizeLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static fi.csc.avaa.tupa.db.model.TpServize addTpServize(
        fi.csc.avaa.tupa.db.model.TpServize tpServize)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addTpServize(tpServize);
    }
    ...
    */
    public static fi.csc.avaa.tupa.db.model.TpServize createTpServize(int id) {
        return getService().createTpServize(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.avaa.tupa.db.model.TpServize deleteTpServize(int id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteTpServize(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.avaa.tupa.db.model.TpServize deleteTpServize(
        fi.csc.avaa.tupa.db.model.TpServize tpServize)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteTpServize(tpServize);
    }
    ...
    */
    ...
    public static fi.csc.avaa.tupa.db.model.TpServize fetchTpServize(int id)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchTpServize(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.avaa.tupa.db.model.TpServize getTpServize(int id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getTpServize(id);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<fi.csc.avaa.tupa.db.model.TpServize> getTpServizes(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getTpServizes(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getTpServizesCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getTpServizesCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.avaa.tupa.db.model.TpServize updateTpServize(
        fi.csc.avaa.tupa.db.model.TpServize tpServize)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateTpServize(tpServize);
    }
    ...
    */
    ...
    public static TpServizeLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    TpServizeLocalService.class.getName());

            if (invokableLocalService instanceof TpServizeLocalService) {
                _service = (TpServizeLocalService) invokableLocalService;
            } else {
                _service = new TpServizeLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(TpServizeLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(TpServizeLocalService service) {
    }
}

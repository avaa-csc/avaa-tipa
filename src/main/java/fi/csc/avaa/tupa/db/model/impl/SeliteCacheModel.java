...
public class SeliteCacheModel implements CacheModel<Selite>, Externalizable {
    ...
    public Selite toEntityModel() {
        ...
        if (classificator == null) {
            seliteImpl.setClassificator(StringPool.BLANK);
        } else {
            seliteImpl.setClassificator(classificator);
        }
    ...
    public void readExternal(ObjectInput objectInput) throws IOException {
        ...
        classificator = objectInput.readUTF();
    }
    ...
    public void writeExternal(ObjectOutput objectOutput)
        ...
        if (classificator == null) {
            ...
            objectOutput.writeUTF(classificator);
        }
    }
}

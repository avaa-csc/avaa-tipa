...
public class PalvelutyyppiModelImpl extends BaseModelImpl<Palvelutyyppi>
    ...
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.column.bitmask.enabled.fi.csc.avaa.tupa.db.model.Palvelutyyppi"),
            true);
    public static long TYYPPI_COLUMN_BITMASK = 1L;
    public static long PALVELUTYYPPI_ID_COLUMN_BITMASK = 2L;
    ...
    private int _tyyppi;
    private int _originalTyyppi;
    private boolean _setOriginalTyyppi;
    ...
    public void setTyyppi(int tyyppi) {
        _columnBitmask |= TYYPPI_COLUMN_BITMASK;

        if (!_setOriginalTyyppi) {
            _setOriginalTyyppi = true;

            _originalTyyppi = _tyyppi;
        }

        _tyyppi = tyyppi;
    }

    public int getOriginalTyyppi() {
        return _originalTyyppi;
    }
    ...
    public void resetOriginalValues() {
        PalvelutyyppiModelImpl palvelutyyppiModelImpl = this;

        palvelutyyppiModelImpl._originalTyyppi = palvelutyyppiModelImpl._tyyppi;

        palvelutyyppiModelImpl._setOriginalTyyppi = false;

        palvelutyyppiModelImpl._columnBitmask = 0;
    }

...
public class Infra_AvainsanatLocalServiceWrapper
    ...
    */
    ...
    public int[] getKeywordsIdsByInfrastructureId(int infrastructureId) {
        return _infra_AvainsanatLocalService.getKeywordsIdsByInfrastructureId(infrastructureId);
    }

    @Override
    public int[] getKeywordsIdsByInfrastructuresIds(int[] infrastructuresIds) {
        return _infra_AvainsanatLocalService.getKeywordsIdsByInfrastructuresIds(infrastructuresIds);
    }

    @Override
    public int[] getInfrastructuresIdsByKeywordsIds(int[] keywordsIds) {
        return _infra_AvainsanatLocalService.getInfrastructuresIdsByKeywordsIds(keywordsIds);
    }

...
/**
 * Provides the local service interface for Infra_Identifier. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CSC
 * @see Infra_IdentifierLocalServiceUtil
...
public interface Infra_IdentifierLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Infra_IdentifierLocalServiceUtil} to access the infra_ identifier local service. Add custom service methods to {@link fi.csc.avaa.tupa.db.service.impl.Infra_IdentifierLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */

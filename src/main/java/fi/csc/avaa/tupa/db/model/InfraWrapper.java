...
public class InfraWrapper implements Infra, ModelWrapper<Infra> {
    ...
    */
    ...
    /**
    * Returns the api_date of this infra.
    *
    * @return the api_date of this infra
    */
    @Override
    public java.util.Date getApi_date() {
        return _infra.getApi_date();
    }

    /**
    * Sets the api_date of this infra.
    *
    * @param api_date the api_date of this infra
    */
    @Override
    public void setApi_date(java.util.Date api_date) {
        _infra.setApi_date(api_date);
    }

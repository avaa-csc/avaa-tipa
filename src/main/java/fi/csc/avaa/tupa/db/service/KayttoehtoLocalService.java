...
/**
 * Provides the local service interface for Kayttoehto. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author CSC
 * @see KayttoehtoLocalServiceUtil
...
public interface KayttoehtoLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link KayttoehtoLocalServiceUtil} to access the kayttoehto local service. Add custom service methods to {@link fi.csc.avaa.tupa.db.service.impl.KayttoehtoLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */

...
public class YhteystietoLocalServiceWrapper implements YhteystietoLocalService,
    ...
    */
    ...
    public int[] getInfrastructuresIdsByContactId(int contactId) {
        return _yhteystietoLocalService.getInfrastructuresIdsByContactId(contactId);
    }

    @Override
    public int[] getServicesIdsByContactId(int contactId) {
        return _yhteystietoLocalService.getServicesIdsByContactId(contactId);
    }

    @Override
    public int[] getOrganisationsIdsByContactId(int contactId) {
        return _yhteystietoLocalService.getOrganisationsIdsByContactId(contactId);
    }

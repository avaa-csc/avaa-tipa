 ...
 * @generated
 */
public class Palvelu_PalvelutyypitLocalServiceClp
    ...
    public Palvelu_PalvelutyypitLocalServiceClp(
        ...
        _methodName19 = "getServiceTypesIdsByServiceId";

        _methodParameterTypes19 = new String[] { "int" };

        _methodName20 = "getServiceTypesIdsByServicesIds";

        _methodParameterTypes20 = new String[] { "int[][]" };

        _methodName21 = "getServicesIdsByServiceTypesIds";
    ...
    public fi.csc.avaa.tupa.db.model.Palvelu_Palvelutyypit addPalvelu_Palvelutyypit(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(palvelu_Palvelutyypit)
                    });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.tupa.db.model.Palvelu_Palvelutyypit) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.tupa.db.model.Palvelu_Palvelutyypit createPalvelu_Palvelutyypit(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(palvelu_PalvelutyypitPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.avaa.tupa.db.model.Palvelu_Palvelutyypit> getPalvelu_Palvelutyypits(
        ...
        return (java.util.List<fi.csc.avaa.tupa.db.model.Palvelu_Palvelutyypit>) ClpSerializer.translateOutput(returnObj);
    }

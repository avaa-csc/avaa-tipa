 ...
 * @generated
 */
public class IdentifierLocalServiceClp implements IdentifierLocalService {
    ...
    public IdentifierLocalServiceClp(
    ...
    public fi.csc.avaa.tupa.db.model.Identifier addIdentifier(
        ...
        return (fi.csc.avaa.tupa.db.model.Identifier) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.tupa.db.model.Identifier createIdentifier(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { identifier_type });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.tupa.db.model.Identifier deleteIdentifier(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { identifier_type });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.tupa.db.model.Identifier fetchIdentifier(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { identifier_type });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.tupa.db.model.Identifier getIdentifier(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { identifier_type });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.avaa.tupa.db.model.Identifier> getIdentifiers(
        ...
        return (java.util.List<fi.csc.avaa.tupa.db.model.Identifier>) ClpSerializer.translateOutput(returnObj);
    }

...
public class SeliteLocalServiceClpInvoker {
    ...
    public SeliteLocalServiceClpInvoker() {
        ...
        _methodName124 = "getDefinitionsIdsByServiceTypes";

        _methodParameterTypes124 = new String[] { "java.lang.String[][]" };

        _methodName125 = "getLocationTypesIdsByLocationTypes";

        _methodParameterTypes125 = new String[] { "java.lang.String[][]" };

        _methodName126 = "getLocationTypesByClassificator";

        _methodParameterTypes126 = new String[] {  };

        _methodName127 = "getServiceTypesByClassificator";

        _methodParameterTypes127 = new String[] {  };

        _methodName130 = "getTypesByDefinitionsIds";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName124.equals(name) &&
            ...
            return SeliteLocalServiceUtil.getDefinitionsIdsByServiceTypes((java.lang.String[]) arguments[0]);
        }

        if (_methodName125.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes125, parameterTypes)) {
            return SeliteLocalServiceUtil.getLocationTypesIdsByLocationTypes((java.lang.String[]) arguments[0]);
        }

        if (_methodName126.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes126, parameterTypes)) {
            return SeliteLocalServiceUtil.getLocationTypesByClassificator();
        }

        if (_methodName127.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes127, parameterTypes)) {
            return SeliteLocalServiceUtil.getServiceTypesByClassificator();
        }

        if (_methodName130.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes130, parameterTypes)) {
            return SeliteLocalServiceUtil.getTypesByDefinitionsIds((int[]) arguments[0]);
        }

 ...
 * @generated
 */
public class TpServizeLocalServiceClp implements TpServizeLocalService {
    ...
    public TpServizeLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "getAllServices";

        _methodParameterTypes19 = new String[] {  };

        _methodName20 = "getServicesByServicesIds";

        _methodParameterTypes20 = new String[] { "int[][]" };

        _methodName21 = "getServicesByInfrastructuresIds";

        _methodParameterTypes21 = new String[] { "int[][]" };

        _methodName22 = "getServicesByInfrastructuresUrns";

        _methodParameterTypes22 = new String[] { "java.lang.String[][]" };

        _methodName23 = "getServicesByOrganisationsIds";

        _methodParameterTypes23 = new String[] { "int[][]" };

        _methodName24 = "getServicesByContactsIds";

        _methodParameterTypes24 = new String[] { "int[][]" };

        _methodName25 = "getServicesByKeywords";

        _methodParameterTypes25 = new String[] { "java.lang.String[][]" };

        _methodName26 = "getServicesByServiceTypes";

        _methodParameterTypes26 = new String[] { "java.lang.String[][]" };

        _methodName27 = "getServiceTypes";

        _methodParameterTypes27 = new String[] {  };

        _methodName28 = "getServicesByLocationTypes";

        _methodParameterTypes28 = new String[] { "java.lang.String[][]" };

        _methodName29 = "getLocationTypes";

        _methodParameterTypes29 = new String[] {  };

        _methodName30 = "getServicesByPostalCodes";

        _methodParameterTypes30 = new String[] { "int[][]" };

        _methodName31 = "getServicesByLocation";

        _methodParameterTypes31 = new String[] { "double", "double" };

        _methodName32 = "getServicesByCountries";
    ...
    public fi.csc.avaa.tupa.db.model.TpServize addTpServize(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(tpServize) });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.tupa.db.model.TpServize) ClpSerializer.translateOutput(returnObj);
    }

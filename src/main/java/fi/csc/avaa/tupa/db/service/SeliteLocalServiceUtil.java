...
public class SeliteLocalServiceUtil {
    ...
    */
    ...
    public static int[] getDefinitionsIdsByServiceTypes(
        java.lang.String[] serviceTypes) {
        return getService().getDefinitionsIdsByServiceTypes(serviceTypes);
    }

    public static int[] getLocationTypesIdsByLocationTypes(
        java.lang.String[] locationTypes) {
        return getService().getLocationTypesIdsByLocationTypes(locationTypes);
    }

    public static java.lang.String[][] getLocationTypesByClassificator() {
        return getService().getLocationTypesByClassificator();
    }

    public static java.lang.String[][] getServiceTypesByClassificator() {
        return getService().getServiceTypesByClassificator();
    }

    public static java.lang.String[] getTypesByDefinitionsIds(
        int[] definitionsIds) {
        return getService().getTypesByDefinitionsIds(definitionsIds);
    }

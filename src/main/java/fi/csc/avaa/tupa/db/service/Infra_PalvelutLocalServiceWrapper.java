...
public class Infra_PalvelutLocalServiceWrapper
    ...
    */
    ...
    public int[] getServicesIdsByInfrastructureId(int infrastructureId) {
        return _infra_PalvelutLocalService.getServicesIdsByInfrastructureId(infrastructureId);
    }

    @Override
    public int[] getServicesIdsByInfrastructuresIds(int[] infrastructuresIds) {
        return _infra_PalvelutLocalService.getServicesIdsByInfrastructuresIds(infrastructuresIds);
    }

    @Override
    public int[] getInfrastructuresIdsByServicesIds(int[] servicesIds) {
        return _infra_PalvelutLocalService.getInfrastructuresIdsByServicesIds(servicesIds);
    }

 ...
 * @generated
 */
public class TpOrganisationLocalServiceClp implements TpOrganisationLocalService {
    ...
    public TpOrganisationLocalServiceClp(
        ...
        _methodName19 = "getAllOrganisations";

        _methodParameterTypes19 = new String[] {  };

        _methodName20 = "getOrganisationsByOrganisationsIds";

        _methodParameterTypes20 = new String[] { "int[][]" };

        _methodName21 = "getOrganisationsByIsnis";

        _methodParameterTypes21 = new String[] { "java.lang.String[][]" };

        _methodName22 = "getOrganisationsByInfrastructuresIds";

        _methodParameterTypes22 = new String[] { "int[][]" };

        _methodName23 = "getOrganisationsByInfrastructuresUrns";

        _methodParameterTypes23 = new String[] { "java.lang.String[][]" };

        _methodName24 = "getOrganisationsByServicesIds";

        _methodParameterTypes24 = new String[] { "int[][]" };

        _methodName25 = "getOrganisationsByContactsIds";

        _methodParameterTypes25 = new String[] { "int[][]" };

        _methodName26 = "getOrganisationsByServiceTypes";

        _methodParameterTypes26 = new String[] { "java.lang.String[][]" };

        _methodName27 = "getOrganisationsByLocationTypes";

        _methodParameterTypes27 = new String[] { "java.lang.String[][]" };

        _methodName28 = "getCountries";
    ...
    public fi.csc.avaa.tupa.db.model.TpOrganisation addTpOrganisation(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(tpOrganisation) });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.tupa.db.model.TpOrganisation) ClpSerializer.translateOutput(returnObj);
    }

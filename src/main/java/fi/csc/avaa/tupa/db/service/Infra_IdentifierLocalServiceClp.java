 ...
 * @generated
 */
public class Infra_IdentifierLocalServiceClp
    ...
    public Infra_IdentifierLocalServiceClp(
        ...
        _methodName19 = "getExtendedInfraIdentifiersList";
    ...
    public fi.csc.avaa.tupa.db.model.Infra_Identifier addInfra_Identifier(
        ...
        return (fi.csc.avaa.tupa.db.model.Infra_Identifier) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.tupa.db.model.Infra_Identifier createInfra_Identifier(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(infra_IdentifierPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.avaa.tupa.db.model.Infra_Identifier> getInfra_Identifiers(
        ...
        return (java.util.List<fi.csc.avaa.tupa.db.model.Infra_Identifier>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.avaa.tupa.db.model.Infra_Identifier> getExtendedInfraIdentifiersList(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { infraId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);

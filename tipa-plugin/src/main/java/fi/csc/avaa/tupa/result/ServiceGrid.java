...
public class ServiceGrid extends AvaaBaseGrid<ServiceGridBean, ExtPalvelu> {
	...
	public ServiceGrid(Translator translator) {
	...
	protected void addListeners() {
		addSelectionListener(e -> {
			...
			if(selectedItemId != null) {
		    	ServiceDetailsWindow window = new ServiceDetailsWindow(translator, TupaDBCache.getPalveluCache().get(container.getItem(selectedItemId).getBean().getPalveluId()));

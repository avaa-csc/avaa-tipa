 ...
 * @generated
 */
public class KayttoehtoLocalServiceClp implements KayttoehtoLocalService {
    ...
    public KayttoehtoLocalServiceClp(
    ...
    public fi.csc.avaa.tupa.db.model.Kayttoehto addKayttoehto(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(kayttoehto) });
        } catch (Throwable t) {
        ...
        return (fi.csc.avaa.tupa.db.model.Kayttoehto) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.avaa.tupa.db.model.Kayttoehto> getKayttoehtos(
        ...
        return (java.util.List<fi.csc.avaa.tupa.db.model.Kayttoehto>) ClpSerializer.translateOutput(returnObj);
    }

...
public class InfraGrid extends AvaaBaseGrid<InfraGridBean, ExtInfra> {
	...
	public InfraGrid(Translator translator) {
	...
	protected void addListeners() {
		addSelectionListener(e -> {
			...
			if(selectedItemId != null) {
		    	InfraDetailsWindow window = new InfraDetailsWindow(translator, TupaDBCache.getInfraCache().get(container.getItem(selectedItemId).getBean().getInfraId()));

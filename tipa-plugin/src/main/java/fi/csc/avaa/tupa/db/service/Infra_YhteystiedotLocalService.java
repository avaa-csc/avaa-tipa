...
/**
 * Provides the local service interface for Infra_Yhteystiedot. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pj,jmlehtin
 * @see Infra_YhteystiedotLocalServiceUtil
...
public interface Infra_YhteystiedotLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Infra_YhteystiedotLocalServiceUtil} to access the infra_ yhteystiedot local service. Add custom service methods to {@link fi.csc.avaa.tupa.db.service.impl.Infra_YhteystiedotLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */

...
/**
 * Provides the local service interface for Palvelu_Palvelutyypit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pj,jmlehtin
 * @see Palvelu_PalvelutyypitLocalServiceUtil
...
public interface Palvelu_PalvelutyypitLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Palvelu_PalvelutyypitLocalServiceUtil} to access the palvelu_ palvelutyypit local service. Add custom service methods to {@link fi.csc.avaa.tupa.db.service.impl.Palvelu_PalvelutyypitLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */

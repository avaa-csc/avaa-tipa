...
/**
 * Provides the local service interface for Palvelutyyppi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pj,jmlehtin
 * @see PalvelutyyppiLocalServiceUtil
...
public interface PalvelutyyppiLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link PalvelutyyppiLocalServiceUtil} to access the palvelutyyppi local service. Add custom service methods to {@link fi.csc.avaa.tupa.db.service.impl.PalvelutyyppiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */

 ...
 * @generated
 */
public class YhteystietoLocalServiceClp implements YhteystietoLocalService {
    ...
    public YhteystietoLocalServiceClp(
    ...
    public fi.csc.avaa.tupa.db.model.Yhteystieto addYhteystieto(
        ...
        return (fi.csc.avaa.tupa.db.model.Yhteystieto) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.avaa.tupa.db.model.Yhteystieto createYhteystieto(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { yhteystieto_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.tupa.db.model.Yhteystieto deleteYhteystieto(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { yhteystieto_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.tupa.db.model.Yhteystieto fetchYhteystieto(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { yhteystieto_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.avaa.tupa.db.model.Yhteystieto getYhteystieto(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { yhteystieto_id });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.avaa.tupa.db.model.Yhteystieto> getYhteystietos(
        ...
        return (java.util.List<fi.csc.avaa.tupa.db.model.Yhteystieto>) ClpSerializer.translateOutput(returnObj);
    }

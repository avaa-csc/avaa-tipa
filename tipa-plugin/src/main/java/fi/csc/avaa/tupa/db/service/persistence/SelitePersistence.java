...
/**
 * The persistence interface for the selite service.
 *
 * <p>
 ...
 * @generated
 */
public interface SelitePersistence extends BasePersistence<Selite> {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link SeliteUtil} to access the selite persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
     */
    ...
    */
    public void cacheResult(fi.csc.avaa.tupa.db.model.Selite selite);
    ...
    */
    public fi.csc.avaa.tupa.db.model.Selite create(int selite_id);
    ...
    */
    public fi.csc.avaa.tupa.db.model.Selite remove(int selite_id)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.avaa.tupa.db.NoSuchSeliteException;

    public fi.csc.avaa.tupa.db.model.Selite updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public fi.csc.avaa.tupa.db.model.Selite findByPrimaryKey(int selite_id)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.avaa.tupa.db.NoSuchSeliteException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public fi.csc.avaa.tupa.db.model.Selite fetchByPrimaryKey(int selite_id)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<fi.csc.avaa.tupa.db.model.Selite> findAll()
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<fi.csc.avaa.tupa.db.model.Selite> findAll(int start,
